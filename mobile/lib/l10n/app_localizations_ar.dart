...
class AppLocalizationsAr extends AppLocalizations {
  ...
  @override
  String get helpScan1 => 'وجّه الكاميرا نحو رمز QR الخاص بالنادي — يُكتشف تلقائياً. تظهر بطاقة تأكيد؛ اضغط "تسجيل الدخول" لتسجيل زيارتك.';
  @override
  ...
  @override
  String get helpSignIn1 => 'اكتب رقم هاتفك — يتحقق التطبيق تلقائياً فور اكتمال الرقم. إن كان لديك حساب بكلمة مرور، يظهر حقلها من تلقاء نفسه. إن كنت جديداً، اضغط متابعة لاستلام رمز التحقق.';
  @override
  String get helpSignIn2 => "رمز الدولة +962 مُعبَّأ مسبقاً. اكتب أرقامك بدءاً من 7 — يمكنك كتابة الصفر البادئ أو تركه، التطبيق يُعالجه تلقائياً. كلٌّ من '780195112' و'0780195112' يعملان بشكل صحيح.";
  @override
  String get helpSignIn3 => "تُفضّل Google؟ اضغط 'المتابعة بجوجل' لتسجيل الدخول عبر حساب Google. تتولى Google شاشة تسجيل الدخول الخاصة بها — لا يوجد رمز OTP من GymPass. فور تأكيد Google تدخل مباشرةً.";
  @override
  String get helpSignIn4 => 'لديك كلمة مرور GymPass؟ فقط أكمل كتابة رقمك — يظهر حقل كلمة المرور تلقائياً فور تعرّف التطبيق على حسابك. لا حاجة للضغط على متابعة أولاً.';
  @override
