...
/// Static dumbbell silhouette — used by [WordmarkRefresh] for the
/// pull-to-refresh indicator. That widget rotates the canvas externally
/// and toggles a glow when active, so it needs a static-shape painter
/// rather than the assembly animation [GymLoader] uses internally. New
/// surfaces should prefer [GymLoader] directly; this painter exists as
/// a stable contract for the refresh indicator.
