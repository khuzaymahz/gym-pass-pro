...
/**
 * Nav iconography — a small, consistent line-icon set (Lucide-derived,
 * 24px grid, 1.8 stroke). Keyed by nav `labelKey` so the Sidebar maps
 * routes → glyphs without a runtime icon dependency. Decorative:
 * always paired with a text label, marked aria-hidden.
 */
