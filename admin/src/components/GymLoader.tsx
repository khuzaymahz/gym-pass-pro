 ...
 *
 * Use anywhere the admin needs an indeterminate "we're working"
 * indicator — replaces generic browser spinners with a recognisably
 * GymPass mark. Same animation as the mobile app's `GymLoader`, so
 * the brand reads consistent across Flutter + web.
 *
