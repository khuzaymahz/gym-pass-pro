...
class ErrorCode(StrEnum):
    ...
    # Legacy: kept for back-compat with mobile clients shipping
    # before 0020. New code raises the more specific OFFERING_*
    # variants below.
    DAY_PASS_NOT_AVAILABLE = "DAY_PASS_NOT_AVAILABLE"
    DAY_PASS_OFFERING_DISABLED = "DAY_PASS_OFFERING_DISABLED"
    DAY_PASS_OFFERING_NOT_CONFIGURED = "DAY_PASS_OFFERING_NOT_CONFIGURED"
    ...
    DAY_PASS_NOT_FOUND = "DAY_PASS_NOT_FOUND"
    DAY_PASS_NOT_REFUNDABLE = "DAY_PASS_NOT_REFUNDABLE"
...
_DEFAULT_STATUS: dict[ErrorCode, int] = {
    ...
    ErrorCode.DAY_PASS_OFFERING_DISABLED: 409,
    ErrorCode.DAY_PASS_OFFERING_NOT_CONFIGURED: 404,
    ...
    ErrorCode.DAY_PASS_NOT_FOUND: 404,
    ErrorCode.DAY_PASS_NOT_REFUNDABLE: 409,
    ErrorCode.RATE_LIMITED: 429,
    ErrorCode.PAYMENT_DECLINED: 402,
    ErrorCode.PAYMENT_GATEWAY_ERROR: 502,
    ErrorCode.PAYMENT_NOT_FOUND: 404,
    ErrorCode.PAYMENT_NOT_REFUNDABLE: 409,
